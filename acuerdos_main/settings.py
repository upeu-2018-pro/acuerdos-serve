"""
Django settings for acuerdos_main project on Heroku. For more info, see:
...
SECRET_KEY = "$i4-61+2aeqee_8a50oim9$7=^x5rol9_!6r1e9zla^2hebhg4"
...
ROOT_URLCONF = 'acuerdos_main.urls'
...
WSGI_APPLICATION = 'acuerdos_main.wsgi.application'
